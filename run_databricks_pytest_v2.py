"""
Submit insurance-quantile pytest suite (v0.3.2, with MeanModelWrapper + new tests)
to Databricks serverless compute.

Run from the project root:
    python run_databricks_pytest_v2.py
"""
...
WORKSPACE_FOLDER = "/Workspace/insurance-quantile-v032"
NOTEBOOK_PATH = f"{WORKSPACE_FOLDER}/run_pytest_v032"
...
if r.returncode != 0:
    ...
    print("insurance-quantile v0.3.2 installed from", pkg_dir)
...
submit_body = {
    "run_name": f"insurance-quantile-pytest-v0.3.2-{RUN_ID}",
    "tasks": [
        {
            "task_key": "pytest",
            "notebook_task": {
